...
export class refactorEntities1667314470780 implements MigrationInterface {
    name = 'refactorEntities1667314470780'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "schedules" ("id" uuid NOT NULL, "day" TIMESTAMP NOT NULL, "hour" TIME NOT NULL, "description" character varying(200) NOT NULL, "userId" uuid, "serviceTypeId" uuid, "professionalId" uuid, CONSTRAINT "PK_7e33fc2ea755a5765e3564e66dd" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "professional" ("id" uuid NOT NULL, "name" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "crm" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "isActive" boolean NOT NULL DEFAULT false, "hospitalId" uuid, "serviceTypeId" uuid, CONSTRAINT "PK_2846b0dcaac01f9983cb719f124" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "hospital" ("id" uuid NOT NULL, "name" character varying NOT NULL, "addressId" uuid, CONSTRAINT "REL_40829aab552323dab29856e316" UNIQUE ("addressId"), CONSTRAINT "PK_10f19e0bf17ded693ea0da07d95" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "address" ("id" uuid NOT NULL, "state" character varying NOT NULL, "city" character varying NOT NULL, "road" character varying NOT NULL, "complement" character varying NOT NULL, "zipCode" character varying NOT NULL, "number" integer NOT NULL, "hospitalId" uuid, CONSTRAINT "REL_927627f0f35eef7a1217adeb67" UNIQUE ("hospitalId"), CONSTRAINT "PK_d92de1f82754668b5f5f5dd4fd5" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "address" ADD CONSTRAINT "FK_927627f0f35eef7a1217adeb673" FOREIGN KEY ("hospitalId") REFERENCES "hospital"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "address" DROP CONSTRAINT "FK_927627f0f35eef7a1217adeb673"`);
