...
const sessionsUser_service_1 = __importDefault(require("../Services/sessions/users/sessionsUser.service"));
const createSessionController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const data = req.body;
    const token = yield (0, sessionsUser_service_1.default)(data);
